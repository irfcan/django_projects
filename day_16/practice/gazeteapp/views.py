...
from gazeteapp.forms import MakaleForm, AuthorForm
...
def author_create(request):
    if request.method == "POST":
        ...
        form = AuthorForm()
    return render(request, "gazeteapp/author-create.html", {"form": form})

def author_edit(request, slug):
    ...
    return render(request, "gazeteapp/author-edit.html", {"form": form})
...
def author_delete(request, slug):
    ...
    return render(request, "gazeteapp/author-delete.html", {"author": author})
